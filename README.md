...
1. Установите зависимости (Composer — опционально)
2. Настройте окружение (`.env`), заполните параметры `app/config.php`
3. Создайте БД и выполните `scripts/database.sql`
4. Настройте виртуальный хост на корень репозитория
5. Убедитесь, что `/storage/*` доступен PHP и закрыт от веб-доступа
